...
numPositionPoints = 11 # Odd is good so central peak is calculated
...
numEnergyPoints = 9 # Effectively *4 for nA, nB, pA and pB.
...
if shouldCalcNew || !isfile(jldFilePath)
    ...
    # Initial: Maxwell-Boltzmann energy - works better for T=5772; for T=300, exp grows too much.
